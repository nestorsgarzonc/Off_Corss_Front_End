    ...
    dbc.CardBody(
        [
            ...
            html.H5("Alekcei Hernández", className="center-text"),
             html.Div(
                    [
                        dbc.Button("", href="https://www.mintic.gov.co/portal/inicio/",color="primary",className="linked_button"),
...
cam = 'Cam 1'
#...
imgx = Image.open('../../../../Downloads/Off_Corss_Front_End (1) 2/Off_Corss_Front_End/Images/Planos_San_Diego_1.jpg')
