...
card_int_1 = [
    ...
    dbc.CardBody(
        [
            dbc.CardImg(src='data:image/png;base64,{}'.format(metrics_img.decode()), top=True, className="card-img-top"),
            html.Hr(className="my-2"),
            dbc.Button("Take me there!", href="/page-4",color="primary", className="metrics_button"),
        ], className="home_card"
    ),
]
...
card_content_1 = [
    ...
    dbc.CardBody(
        [
            dbc.CardImg(src='data:image/jpg;base64,{}'.format(encoded_crew1.decode()), top=True, className="radius_img"),
            html.H5("Alekcei Hernández", className="center-text"),
             html.Div(
                    [
                        dbc.Button("", href="https://www.linkedin.com/in/alekceinosach/",color="primary",className="linked_button"),
                        dbc.Button("", href="mailto:alekcei.1519@gmail.com",color="primary",className="email_button"),
                    ],
                    )
...
card_content_2 = [
    ...
    dbc.CardBody(
        [
            dbc.CardImg(src='data:image/jpg;base64,{}'.format(encoded_crew2.decode()), top=True, className="radius_img"),
            html.H5("Alexander Sandoval", className="center-text"),
            html.Div(
                   [
                       dbc.Button("", href="https://www.linkedin.com/in/alexander-sandoval-202003/",color="primary",className="linked_button"),
                       dbc.Button("", href="mailto:asandovalo@unal.edu.co",color="primary",className="email_button"),
                   ],
                   )
        ], className="radius_card"
    ),
...
card_content_3 = [
    ...
    dbc.CardBody(
        [
            dbc.CardImg(src='data:image/jpg;base64,{}'.format(encoded_crew3.decode()), top=True, className="radius_img"),
            html.H5("David Henriquez", className="center-text"),
            html.Div(
                   [
                       dbc.Button("", href="https://www.linkedin.com/in/david-henriquez-bernal/",color="primary",className="linked_button"),
                       dbc.Button("", href="mailto:da.henriquez94@gmail.com",color="primary",className="email_button"),
                   ],
                   )
        ], className="radius_card"
    ),
...
card_content_4 = [
    ...
    dbc.CardBody(
        [
            dbc.CardImg(src='data:image/jpg;base64,{}'.format(encoded_crew4.decode()), top=True, className="radius_img"),
            html.H5("Guillermo Valencia", className="center-text"),
            html.Div(
                   [
                       dbc.Button("", href="https://www.linkedin.com/in/guillermo-valencia-53a150a4/",color="primary",className="linked_button"),
                       dbc.Button("", href="mailto:ga.valencia123@gmail.com",color="primary",className="email_button"),
                   ],
                   )
        ], className="radius_card"
    ),
...
card_content_5 = [
    ...
    dbc.CardBody(
        [
            dbc.CardImg(src='data:image/jpg;base64,{}'.format(encoded_crew5.decode()), top=True, className="radius_img"),
            html.H5("Harold García", className="center-text"),
            html.Div(
                   [
                       dbc.Button("", href="https://www.linkedin.com/in/haroldgiovannygarciar",color="primary",className="linked_button"),
                       dbc.Button("", href="mailto:haroldgarciar94@gmail.com",color="primary",className="email_button"),
                   ],
                   )
        ], className="radius_card"
    ),
...
card_content_6 = [
    ...
    dbc.CardBody(
        [
            dbc.CardImg(src='data:image/jpg;base64,{}'.format(encoded_crew6.decode()), top=True, className="radius_img"),
            html.H5("Sebastian Garzón", className="center-text"),
            html.Div(
                   [
                       dbc.Button("", href="https://www.linkedin.com/in/sebastiangarzonc/",color="primary",className="linked_button"),
                       dbc.Button("", href="mailto:nestorsgarzonc@gmail.com",color="primary",className="email_button"),
                   ],
                   )
        ], className="radius_card"
    ),
...
card_content_7 = [
    ...
    dbc.CardBody(
        [
            dbc.CardImg(src='data:image/jpg;base64,{}'.format(encoded_crew7.decode()), top=True, className="radius_img"),
            html.H5("Nicolás González", className="center-text"),
            html.Div(
                   [
                       dbc.Button("", href="https://www.linkedin.com/in/jose-nicol%C3%A1s-gonz%C3%A1lez-guatibonza-41205076/",color="primary",className="linked_button"),
                       dbc.Button("", href="mailto:nicolas.gonzalezg@hotmail.com",color="primary",className="email_button"),
                   ],
                   )
        ], className="radius_card"
    ),
                        ...
                        [dbc.Col(
                         ...
                         dbc.Col(
                                dbc.FormGroup([Cam_picker,
                                               ...
                                               dbc.Spinner(html.Div(id="loading-output-III"))])
                                )
                        ])
                  ])
#///////////////////////////////////////////////////////////////////////////////////////////////////
                        ...
                        [dbc.Col(
                         ...
                         dbc.Col(
                                dbc.FormGroup([Cam_picker_II,
                                               ...
                                               dbc.Spinner(html.Div(id="loading-output-II")),])
                                )
                        ])
                  ])
...
def filter_df(engine, store, date, start_hour, start_min, end_hour, end_min, cam):
    ...
    tracker_conn = connection.execute(text(query), group='san diego', A=start_date, B=end_date, C=int(cam[-1]), O='person').fetchall()
...
Graphs_tracker = html.Div([
                               ...
                               html.Hr(),
                               html.P("Store Traffic Heat Map",className="P_style"),
                               dcc.Graph(figure=heat_map, id="heat_traffic"),
                               html.Hr(),
                               html.P("Traffic Lineplot History over the selected Time Range",className="P_style"),
...
def count_plot(counts_dt, filter_1 = 'day_of_week_name', filter_2 = 'hour'):
  ...
  into.loc[:,'day_of_week_name'] = into.Start_date.dt.weekday.map(dw_mapping)
  ...
  df_plot = into.groupby([vars_select[0], vars_select[1]]).sum()['Count'].reset_index()
...
card_count_2 = [
    dbc.CardHeader("Total count of customer out-traffic:", className="crew_card"),
    dbc.CardBody(
        [
...
video_library=dbc.FormGroup(
                    [
                        ...
                        dcc.Dropdown(
                            ...
                            options=[
                                {"label": "Outlet_Americas_1", "value": 'Outlet_Americas_1'},
                                {"label": "Outlet_Americas_2", "value": 'Outlet_Americas_2'},
                                {"label": "Outlet_Galerias_1", "value": 'Outlet_Galerias_1'},
                            ],
                            value='Outlet_Americas_1'
                        ),
                        dbc.Button("Launch!",id='submit-val-III', n_clicks=0,className="ico_submit"),
...
card_video_trail = dbc.Card(
    [
        ...
        dbc.CardFooter("Please select a video available from the library", className="foot_video_picker"),
    ],
...
final_video_lib=html.Div([
    ...
    dbc.Row([
             dbc.Col(dbc.FormGroup([card_video_trail,
                                    ...
                                    html.Hr(),
                                    html.P("Quick Heat Trail results: You will see a red trail of the people's traffic captured from the video above",
                                           className="P_style"),
                                    html.Hr(),
        ...
        dbc.Collapse(
            dbc.Nav(
                [
                    ...
                    dbc.NavLink("Quick heat video analysis", href="/page-2", id="page-2-link", className="ico_upload"),
                    #----------------------------------------------------------------------------------------
                    dbc.Button(
                                "Store's Metrics",
                                className="ico_store",
                    ...
                    html.P(
                    dbc.CardImg(src='data:image/png;base64,{}'.format(encoded_logo.decode()), top=True,className="radius_img_logo"),
                           ),
                ],
                vertical=True,
                pills=True,
...
def render_page_content(pathname):
    if pathname in ["/", "/page-1"]:
        ...
        return html.Div([card_trends,
                        ...
                        dbc.CardColumns(
                            [
                                dbc.Card(card_count_1,className="center_cardc"),
                                dbc.Card(card_count_2,className="center_cardc")
                            ],
                        ),
                        Graphs_counter,
                        html.Hr(),
                        html.P("Blue Print Cam Reference", className="P_style"),
                        dbc.CardImg(src='data:image/jpg;base64,{}'.format(san_diego_ref.decode()), top=True,
                                    className="blueprint_style"),])
...
def update_output(video_name,submit):
    ...
    if 'submit-val-III' in changed_id and video_name is not None:
        ...
        video_file='Images/Sample_videos/'+ video_name +'.mp4'
        video_file_x=zip(video_file)
        #Play the video
        if video_name=="Outlet_Americas_1":
            video_player =html.Iframe(width="560", height="315", src="https://www.youtube.com/embed/fJo9A3OhNfM")
        elif video_name=="Outlet_Americas_2":
            video_player =html.Iframe(width="560", height="315", src="https://www.youtube.com/embed/BnH67JXD36k")
        else:
            video_player =html.Iframe(width="560", height="315", src="https://www.youtube.com/embed/wBh-mp83nak")
        #Build the analysis
        payload = {}
        files = [('file', open(video_file,'rb'))]
        headers= {}
        response = requests.request("POST", url+'/uploadHeatmapVideo', headers=headers, data = payload, files = files)
        file = open("sample_image.png", "wb")
        file.write(response.content)
        file.close()
        back_result='sample_image.png'
        encoded_result = base64.b64encode(open(back_result, 'rb').read())
        image_heat=dbc.CardImg(src='data:image/png;base64,{}'.format(encoded_result.decode()), className="display-4")
        return image_heat,video_player,submit
    else:
...
@app.callback([Output('map_traffic', 'figure'),
               ...
               Output("loading-output-III", "children")],
...
@app.callback([Output('count_week', 'figure'),
               ...
               Output("loading-output-II", "children")],
...
def process_form_II(start_hour,start_minute,end_hour,end_min,cam,start_date,end_date,submit):
    ...
    if 'submit-val-II' in changed_id:
        ...
        #------------------------------------
        engine = get_db()
        counts_dt = counter_df(engine, store, start_date, end_date, start_hour, start_minute, end_hour, end_min, cam)
        count_week_org = count_plot(counts_dt, filter_1 = 'day_of_week_name', filter_2 = 'hour')
        count_week=count_week_org['fig']
        count_in=count_week_org['in']
        count_out=count_week_org['out']
        return count_week,count_in,count_out,submit
