...
jumbotron_int = dbc.Jumbotron(
    [
        ...
        html.P(
             dbc.CardImg(src='data:image/png;base64,{}'.format(encoded_logo.decode()), top=True,className="radius_img"),
        ),
        jumbotron_links
    ],
            ...
            html.H5("Alekcei Hernández", className="center-text"),
             html.Div(
                    [
                        ...
                        dbc.Button("", href="https://www.correlation-one.com/ds4a-latam",color="primary",className="email_button"),
                    ],
                    )
...
video_library=dbc.FormGroup(
                    [
                        ...
                        html.Button('Launch!', id='submit-val-III', n_clicks=0,className="ico_submit"),
                    ],className="form_style"
                )
